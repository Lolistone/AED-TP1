...
$\textbf Q_{c} \equiv (0 \leq primero, segundo < |escrutinio| - 1) \yLuego \paraTodo[unalinea]{i}{\ent}{0 \leq i < |escrutinio| - 1 \land i \neq primero \land 
i \neq segundo \implicaLuego \\ escrutinio[i] < escrutinio[segundo] < escrutinio[primero]} \vspace{0.1cm} $ \\
(Similar al asegura, con la diferencia de que no hablamos de res) \vspace{0.1cm} \\
...
j \neq segundo \implicaLuego \\ escrutinio[j] < escrutinio[segundo] < escrutinio[primero]} $ \vspace{0.1cm} \\
...
\begin{itemize}\setlength{\itemindent}{0.5cm}
	...
	\item  $\paraTodo[unalinea]{j}{\ent}{0 \leq j < i \land j \neq primero \land  j \neq segundo \implicaLuego  escrutinio[j] < escrutinio[segundo] < escrutinio[primero]}  (1)$
\end{itemize}
...
\begin{itemize}\setlength{\itemindent}{0.5cm}
	...
	\item   $\paraTodo[unalinea]{i}{\ent}{0 \leq i < |escrutinio| - 1 \land i \neq primero \land i \neq segundo \implicaLuego escrutinio[i]< escrutinio[segundo]<escrutinio[primero]}$ Vale pues aparece la misma expresión
\end{itemize}
...
\noindent \textbf{wp}(i := i + 1, I) $\equiv$ def(i+1) $\yLuego$ $0 \leq i + 1 \leq |escrutinio| - 1 \yLuego  (0 \leq primero, segundo < i + 1) \yLuego \\ \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq primero \land  j \neq segundo \implicaLuego escrutinio[j] < escrutinio[segundo] < escrutinio[primero]} $ \\

\noindent $\equiv 0 \leq i + 1 \leq |escrutinio| - 1 \yLuego  (0 \leq primero, segundo < i + 1) \yLuego \\ \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq primero \land  j \neq segundo \implicaLuego escrutinio[j] < escrutinio[segundo] < escrutinio[primero]} \equiv E_5$ \\

\noindent \textbf{wp}(If ..., $E_5$), por Axioma 4 tenemos que, \\

\noindent $\equiv def(escrutinio[i] > escrutinio[primero]) \yLuego \\ ((escrutinio[i] > escrutinio[primero] \land wp(segundo := primero; primero := i, E_5)) \lor \\
(escrutinio[i] \leq escrutinio[primero] \land wp(If..., E_5)) ) \\$

\noindent Veamoslos por separados, \\

\noindent \textbf{wp}$(segundo := primero; primero := i, E_5) \equiv wp(segundo := primero, wp(primero := i, E_5))$ \\

\noindent \textbf{wp}$(primero := i, E_5)) \equiv def(i) \land 0 \leq i + 1 \leq |escrutinio| - 1 \yLuego  (0 \leq i, segundo < i + 1) \yLuego \\ \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq i \land  j \neq segundo \implicaLuego escrutinio[j] < escrutinio[segundo] < escrutinio[i]} \equiv E_6 $ \\

\noindent \textbf{wp}$(segundo := primero, E_6)) \equiv def(primero) \land 0 \leq i + 1 \leq |escrutinio| - 1 \yLuego  (0 \leq i, primero < i + 1) \yLuego \\ \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq i \land  j \neq primero \implicaLuego escrutinio[j] < escrutinio[primero] < escrutinio[i]} \equiv E_7 $ \\

\noindent Vemos el lado izquiero del $\lor$, \\

\noindent $(escrutinio[i] > escrutinio[primero] \land E_7)$ \\ 

\noindent $\equiv (escrutinio[i] > escrutinio[primero] \land 0 \leq i + 1 \leq |escrutinio| - 1 \yLuego  0 \leq primero < i + 1 \yLuego \\ \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq i \land  j \neq primero \implicaLuego escrutinio[j] < escrutinio[primero] < escrutinio[i]}$ \\

\noindent Por otro lado, \\

\noindent \textbf{wp}$(If ..., E_5) \equiv def(escrutinio[primero] > escrutinio[i] > escrutinio[segundo]) \yLuego \\
((escrutinio[primero] > escrutinio[i] > escrutinio[segundo] \land wp(segundo := i, E_5)) \lor \\
(escrutinio[primero] \leq escrutinio[i] \lor escrutinio[i] \leq escrutinio[segundo] \land wp(skip, E_5)) $ \\

\noindent $\equiv 0 \leq primero, segundo, i < |escrutinio|  \yLuego \\
((escrutinio[primero] > escrutinio[i] > escrutinio[segundo] \land def(i) \yLuego 0 \leq i + 1 \leq |escrutinio| - 1 \yLuego \\ (0 \leq primero, i < i + 1) \yLuego \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq primero \land  j \neq i \implicaLuego \\ escrutinio[j] < escrutinio[i] < escrutinio[primero]}) \lor \\
(escrutinio[primero] \leq escrutinio[i] \lor escrutinio[i] \leq escrutinio[segundo] \land E_5)) $ \\

\noindent $\equiv 0 \leq primero, segundo, i < |escrutinio|  \yLuego \\
((escrutinio[primero] > escrutinio[i] > escrutinio[segundo] \land 0 \leq i + 1 \leq |escrutinio| - 1 \yLuego \\ (0 \leq primero, i < i + 1) \yLuego \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq primero \land  j \neq i \implicaLuego \\ escrutinio[j] < escrutinio[i] < escrutinio[primero]}) \lor \\
(escrutinio[primero] \leq escrutinio[i] \lor escrutinio[i] \leq escrutinio[segundo] \land E_5)) $ \\

\noindent Ahora, el lado derecho del or, \\

\noindent $escrutinio[i] \leq escrutinio[primero] \land 0 \leq primero, segundo, i < |escrutinio|  \yLuego \\
((escrutinio[primero] > escrutinio[i] > escrutinio[segundo] \land 0 \leq i + 1 \leq |escrutinio| - 1 \yLuego \\ (0 \leq primero, i < i + 1) \yLuego \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq primero \land  j \neq i \implicaLuego \\ escrutinio[j] < escrutinio[i] < escrutinio[primero]}) \lor \\
(escrutinio[primero] \leq escrutinio[i] \lor escrutinio[i] \leq escrutinio[segundo] \land E_5)) $ \\

\newpage

\noindent $\equiv escrutinio[i] \leq escrutinio[primero] \land 0 \leq primero, segundo, i < |escrutinio|  \yLuego \\
((escrutinio[primero] > escrutinio[i] > escrutinio[segundo] \land 0 \leq i + 1 \leq |escrutinio| - 1 \yLuego \\ (0 \leq primero, i < i + 1) \yLuego \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq primero \land  j \neq i \implicaLuego \\ escrutinio[j] < escrutinio[i] < escrutinio[primero]}) \lor \\
(escrutinio[primero] \leq escrutinio[i] \lor escrutinio[i] \leq escrutinio[segundo] \land  0 \leq i + 1 \leq |escrutinio| - 1 \yLuego \\ (0 \leq primero, segundo < i + 1) \yLuego \\ \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq primero \land  j \neq segundo \implicaLuego escrutinio[j] < escrutinio[segundo] < escrutinio[primero]})) $ \\

\noindent Juntamos todo,  \\

\noindent Y, queremos ver que $I \land B \rightarrow$ \textbf{wp}$(If ..., E_5)$  \\

\noindent $\equiv ((escrutinio[i] > escrutinio[primero] \land 0 \leq i + 1 \leq |escrutinio| - 1 \yLuego  0 \leq primero < i + 1 \yLuego \\ \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq i \land  j \neq primero \implicaLuego escrutinio[j] < escrutinio[primero] < escrutinio[i]}) \lor \\
(escrutinio[i] \leq escrutinio[primero] \land 0 \leq primero, segundo, i < |escrutinio|  \yLuego \\
((escrutinio[primero] > escrutinio[i] > escrutinio[segundo] \land 0 \leq i + 1 \leq |escrutinio| - 1 \yLuego \\ (0 \leq primero, i < i + 1) \yLuego \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq primero \land  j \neq i \implicaLuego \\ escrutinio[j] < escrutinio[i] < escrutinio[primero]}) \lor \\
(escrutinio[primero] \leq escrutinio[i] \lor escrutinio[i] \leq escrutinio[segundo] \land  0 \leq i + 1 \leq |escrutinio| - 1 \yLuego \\ (0 \leq primero, segundo < i + 1) \yLuego \\ \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq primero \land  j \neq segundo \implicaLuego escrutinio[j] < escrutinio[segundo] < escrutinio[primero]}))) ) \\$

\noindent $\equiv ((escrutinio[i] > escrutinio[primero] \land \\ \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq i \land  j \neq primero \implicaLuego escrutinio[j] < escrutinio[primero] < escrutinio[i]}) \textbf{ORGRAnde}\lor \\
(escrutinio[i] \leq escrutinio[primero] \land  \textbf{Ygrande} \\
((escrutinio[primero] > escrutinio[i] > escrutinio[segundo] \land \\ \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq primero \land  j \neq i \implicaLuego \\ escrutinio[j] < escrutinio[i] < escrutinio[primero]}) \lor \\
(escrutinio[primero] \leq escrutinio[i] \lor escrutinio[i] \leq escrutinio[segundo] \land \\ \paraTodo[unalinea]{j}{\ent}{0 \leq j < i + 1 \land j \neq primero \land  j \neq segundo \implicaLuego escrutinio[j] < escrutinio[segundo] < escrutinio[primero]}))) ) \\$


\noindent $\textbf B \equiv i < |escrutinio| - 1 $ \vspace{0.1cm}\\
(Es la guarda del ciclo) \vspace{0.1cm} \\
$\textbf I \equiv 0 < i \leq |escrutinio| - 1 \yLuego  (0 \leq primero, segundo < i) \yLuego \paraTodo[unalinea]{j}{\ent}{0 \leq j < i \land j \neq primero \land 
j \neq segundo \implicaLuego \\ escrutinio[j] < escrutinio[segundo] < escrutinio[primero]} $ \vspace{0.1cm} \\
