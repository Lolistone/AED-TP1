...
\noindent Luego, como Requiere $\equiv$ $E_3$, Requiere $\rightarrow$ $E_3$ que es lo que queríamos ver.
...
\noindent (1) Como i = 1, el único valor que cumple 0 $\leq j < i$ es j = 0, pero como primero y segundo son iguales a cero todo el antecedente es falso.
