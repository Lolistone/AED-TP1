...
\noindent Nos queda probar $\{I \land B \land v_0 = |escrutinio\_presidencial| - i\}$CuerpoDelCiclo$\{|escrutinio\_presidencial| - i < v_0\}$ \\

\noindent Calculemos wp(CuerpoDelCiclo, |escrutinio$\_$presidencial| - i < $v_0$) \\
